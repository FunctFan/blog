...
我们这里都是取第一次的存储所耗费的时间。如果你要像我一样通过多次测试去平均值的话，你每测试完一次之后需要重新初始化 IPFS 节点，
这样测试虽然挺繁琐的，但是结果比较精确。
...
那如果我们在进一步考虑到由于 IPFS 本身的各种优势以及特点，IPFS 节点是自带 CDN 加速的，也就是说节点越多，IPFS 的存储系统的读取效率将会更高，我们有充分的
